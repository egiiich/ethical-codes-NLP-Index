...
### worker_to_manager
- `topic_title_ru`: Отношение сотрудников к руководителям
- `scope_ru`: Уважительное отношение, честность, добростовестное выполнение поручений, уважительное выражение несогласия
- `principles_path`: `docs/principles/worker_to_manager.md`
